...
/// one of its ancestors to be a [Material] widget. When the [MyTextField] is
...
///    [MyTextField]. (The [EditableText] widget is rarely used directly unless
...
class MyTextField extends StatefulWidget {
  ...
  /// is ignored, unless [maxLengthEnforced] is set to false. The MyTextField
  ...
  /// ## Limitations
  ///
  /// The MyTextField does not currently count Unicode grapheme clusters (i.e.
...
class _MyTextFieldState extends State<MyTextField> with AutomaticKeepAliveClientMixin {
  final GlobalKey<MyEditableTextState> _editableTextKey = GlobalKey<MyEditableTextState>();
  ...
  InputDecoration _getEffectiveDecoration() {
    ...
    if (widget.maxLength != MyTextField.noMaxLength) {
  ...
  MyRenderEditable get _renderEditable => _editableTextKey.currentState.renderEditable;
