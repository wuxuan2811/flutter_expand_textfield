...
typedef MySelectionChangedHandler = void Function(TextSelection selection, MyRenderEditable renderObject, SelectionChangedCause cause);
...
class MyRenderEditable extends RenderBox {
  ...
  MyRenderEditable({
    ...
    @required this.textSelectionDelegate,
       ...
       assert(textDirection != null, 'MyRenderEditable created without a textDirection.'),
  ...
  MyTextEditingController cotroller;
  ...
  void selectPosition({@required SelectionChangedCause cause}) {
    ...
    if (onSelectionChanged != null) {
      ...
      var newSelection = cotroller.adjustSelectPosition(position)??TextSelection.fromPosition(position);
  ...
  void selectWord({@required SelectionChangedCause cause}) {
    ...
    if (onSelectionChanged != null) {
      final TextPosition position = _textPainter.getPositionForOffset(globalToLocal(_lastTapDownPosition));
      var newSelection = cotroller.adjustSelectWord(position)??_selectWordAtOffset(position);
      onSelectionChanged(newSelection, this, cause);
    }
  }
