...
class _MyAppState extends State<MyApp> {
  MyTextEditingController _editCtrl = new MyTextEditingController(
      ...
      atStyle: new TextStyle(fontWeight: FontWeight.bold, color: Colors.green),
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(textSelectionColor: Colors.red),
      home: Scaffold(
            ...
            new Row(
              ...
              children: <Widget>[
                new RaisedButton(
                  child: new Text("插表情"),
                  onPressed: () {
                    _editCtrl.insertSpanInfo(new EmojiInfo(
                        id: 0,
                        url: "packages/real_rich_text/images/emoji_10.png"));
                  },
                ),
                new RaisedButton(
                  child: new Text("插话题"),
                  onPressed: () {
                    /*_editCtrl
                        .insertSpanInfo(new TopicInfo(id: 0, name: "流浪地球"));*/
                    _editCtrl.insertSpanInfo(new EmojiInfo(
                        id: 0,
                        url: "packages/real_rich_text/images/emoji_9.png"));
                  },
                ),
                new RaisedButton(
                  child: new Text("插@"),
                  onPressed: () {
                    _editCtrl
                        .insertSpanInfo(new AtInfo(uid: 0, nickname: "黄彧钊"));
                  },
                ),
                new RaisedButton(
